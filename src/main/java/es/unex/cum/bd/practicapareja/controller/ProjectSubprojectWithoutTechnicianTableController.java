...
public class ProjectSubprojectWithoutTechnicianTableController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ObservableList<ProjectSubproject> observableList = FXCollections.observableArrayList(projectSubprojectDao.getAllWithout());
